...
export const FILTER_LABELS = {
  pt: {
    ...
    acervo_sub: '(É preciso selecionar um ou mais museus para buscar)',
    artista: 'Artistas',
    artista_sub: '(É preciso selecionar um ou mais artistas para buscar)',
    education: 'Formação',
    education_sub: '(É preciso selecionar uma ou mais instituições para buscar)',
    nacionalidade: 'Nacionalidade',
    gender: 'Gênero',
  },
  en: {
    acervo: 'Museums and Archives',
    acervo_sub: '(You must select one or more museums to search)',
    artista: 'Artists',
    artista_sub: '(You must select one or more artists to search)',
    education: 'Education',
    education_sub: '(You must select one or more institutions to search)',
